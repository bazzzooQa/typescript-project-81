...
test('form for template with input', () => {
    ...
    })).toBe('<form method="post" action="#"><label for="name">Name</label><input name="name" type="text" value="rob"><label for="job">Job</label><textarea name="job" type="text" rows="50" cols="50">hexlet</textarea></form>')
});
